<template>
    <div class="panel-layout" :key="$page.component">
        ...
        <!-- Header / Nav -->
        <nav class="navbar navbar-expand-lg bg-white sticky-top" aria-label="Navigasi Utama">
            <div class="container">
                ...
                <div id="navMain" class="collapse navbar-collapse">
                    <ul class="navbar-nav ms-auto align-items-lg-center">
                        ...
                        <li class="nav-item ms-lg-3">
                            <a class="btn btn-sm cta-primary text-white" href="#contact">
                                Pesan Jajanan di Palu
                            </a>
                        </li>
                    </ul>
                </div>
